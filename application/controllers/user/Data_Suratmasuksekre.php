...
class Data_Suratmasuksekre extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('user/suratmasuk/data_suratmasuksekre', $data);
    ...
    public function tambah_data()
    {
        ...
        $this->load->view('template_user/header', $data);
        $this->load->view('template_user/sidebar');
        $this->load->view('user/suratmasuk/tambah_datasuratmasuksekre', $data);
        $this->load->view('template_user/footer');
    }
    ...
    public function tambah_data_aksi()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect('user/data_suratmasuksekre');
        }
    }
    ...
    public function detail_data($id)
    {
        ...
        $this->load->view('template_user/header', $data);
        $this->load->view('template_user/sidebar');
        $this->load->view('user/suratmasuk/detail_datasuratmasuksekre', $data);
        $this->load->view('template_user/footer');
    }
