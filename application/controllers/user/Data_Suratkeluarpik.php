...
class Data_Suratkeluarpik extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('user/suratkeluar/data_suratkeluarpik', $data);
    ...
    public function tambah_data()
    {
        ...
        $this->load->view('template_user/header', $data);
        $this->load->view('template_user/sidebar');
        $this->load->view('user/suratkeluar/tambah_datasuratkeluarpik', $data);
        $this->load->view('template_user/footer');
    }
    ...
    public function tambah_data_aksi()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect('user/data_suratkeluarpik');
        }
    }
    ...
    public function detail_data($id)
    {
        ...
        $this->load->view('template_user/header', $data);
        $this->load->view('template_user/sidebar');
        $this->load->view('user/suratkeluar/detail_datasuratkeluarpik', $data);
        $this->load->view('template_user/footer');
    }
