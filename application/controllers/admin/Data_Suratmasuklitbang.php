...
class Data_Suratmasuklitbang extends CI_Controller
{
    ...
    {
        $data['title'] = "Data Surat Masuk Bidang Penelitian Dan Pengembangan";
        $data['suratmasuk'] = $this->ModelPenggajian->get_data('data_suratmasuklitbang')->result();

        $this->load->view('template_admin/header', $data);
        $this->load->view('template_admin/sidebar');
        $this->load->view('admin/suratmasuk/data_suratmasuklitbang', $data);
    ...
    public function tambah_data()
    {
        ...
        $this->load->view('template_admin/header', $data);
        $this->load->view('template_admin/sidebar');
        $this->load->view('admin/suratmasuk/tambah_datasuratmasuklitbang', $data);
        $this->load->view('template_admin/footer');
    }
    ...
    public function tambah_data_aksi()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect('admin/data_suratmasuklitbang');
        }
    }
    ...
    public function update_data($id)
    {
        ...
        $this->load->view('template_admin/header', $data);
        $this->load->view('template_admin/sidebar');
        $this->load->view('admin/suratmasuk/update_datasuratmasuklitbang', $data);
        $this->load->view('template_admin/footer');
    }
    ...
    public function update_data_aksi()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->ModelPenggajian->update_data('data_suratmasuklitbang', $data, $where);
            $this->session->set_flashdata('pesan', '<div class="alert alert-success alert-dismissible fade show" role="alert">
    ...
    {
        $where = array('id' => $id);
        $this->ModelPenggajian->delete_data($where, 'data_suratmasuklitbang');
        $this->session->set_flashdata('pesan', '<div class="alert alert-danger alert-dismissible fade show" role="alert">
    ...
    public function detail_data($id)
    {
        ...
        $this->load->view('template_admin/header', $data);
        $this->load->view('template_admin/sidebar');
        $this->load->view('admin/suratmasuk/detail_datasuratmasuklitbang', $data);
        $this->load->view('template_admin/footer');
    }
