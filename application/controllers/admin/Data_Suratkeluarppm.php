...
class Data_Suratkeluarppm extends CI_Controller
{
    ...
    {
        $data['title'] = "Data Surat Keluar Bidang Pemerintahan Dan Pembangunan Manusia";
        $data['suratkeluar'] = $this->ModelPenggajian->get_data('data_suratkeluarppm')->result();

        $this->load->view('template_admin/header', $data);
        $this->load->view('template_admin/sidebar');
        $this->load->view('admin/suratkeluar/data_suratkeluarppm', $data);
    ...
    public function tambah_data()
    {
        ...
        $this->load->view('template_admin/header', $data);
        $this->load->view('template_admin/sidebar');
        $this->load->view('admin/suratkeluar/tambah_datasuratkeluarppm', $data);
        $this->load->view('template_admin/footer');
    }
    ...
    public function tambah_data_aksi()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect('admin/data_suratkeluarppm');
        }
    }
    ...
    public function update_data($id)
    {
        ...
        $this->load->view('template_admin/header', $data);
        $this->load->view('template_admin/sidebar');
        $this->load->view('admin/suratkeluar/update_datasuratkeluarppm', $data);
        $this->load->view('template_admin/footer');
    }
    ...
    public function update_data_aksi()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->ModelPenggajian->update_data('data_suratkeluarppm', $data, $where);
            $this->session->set_flashdata('pesan', '<div class="alert alert-success alert-dismissible fade show" role="alert">
    ...
    {
        $where = array('id' => $id);
        $this->ModelPenggajian->delete_data($where, 'data_suratkeluarppm');
        $this->session->set_flashdata('pesan', '<div class="alert alert-danger alert-dismissible fade show" role="alert">
    ...
    public function detail_data($id)
    {
        ...
        $this->load->view('template_admin/header', $data);
        $this->load->view('template_admin/sidebar');
        $this->load->view('admin/suratkeluar/detail_datasuratkeluarppm', $data);
        $this->load->view('template_admin/footer');
    }
