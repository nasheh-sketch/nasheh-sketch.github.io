...
<div class="card" style="width: 60% ; margin-bottom: 100px">
    <div class="card-body">
        <form method="POST" action="<?php echo base_url('admin/data_suratmasukp2epd/tambah_data_aksi') ?>" enctype="multipart/form-data">
            ...
            <a href="<?php echo base_url('admin/data_suratmasukp2epd') ?>" class="btn btn-warning">Kembali</a>
