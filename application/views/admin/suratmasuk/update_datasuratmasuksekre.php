...
<div class="card" style="width: 60% ; margin-bottom: 100px">
	<div class="card-body">
		...
		<?php foreach ($suratmasuk as $sm) : ?>
			<form method="POST" action="<?php echo base_url('admin/data_suratmasuksekre/update_data_aksi') ?>" enctype="multipart/form-data">
				...
				<a href="<?php echo base_url('admin/data_suratmasuksekre') ?>" class="btn btn-warning">Kembali</a>
